 ...
 */
@Configuration @PropertySource("classpath:mybatis.properties") public class mybatisConfig {
     ...
     * @throws Exception
     */
   /* @Bean @Profile("dev") public DataSource dataSource1() throws Exception {
    ...
    @Bean @Profile("default") public DataSource dataSource2() throws Exception {
